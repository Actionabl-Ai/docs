...
- ****Application path, application user, ****and****application password****   define how the script will connect to the external resource. 
...
The DocuSign App Connector uses a Service Profile and an ESign template you previously created to send a set of documents out for signatures.
