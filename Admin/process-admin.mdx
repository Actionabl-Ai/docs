...
- **ESign Template**: Template that creates and defines the routing for a document requiring electronic signatures.

### Creating Email Account Records

PM67

### Creating Email Template Records

PM68

### Creating Email Template Section Records

### Creating Message Template Records
