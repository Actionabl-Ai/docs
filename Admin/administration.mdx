...
<Tip>
  **_If you are a new technical administrator of Actionabl, you should first review _**[**_<u>Getting Started with Actionabl</u>_**](/GettingStarted/getting-started)**_ to familiarize yourself with the key concepts and terms used throughout this document._**
</Tip>

**_Related Documents:_**

- [**_Controller Guide_**](/Controller/controller-guide)**_ _**covers all aspects of the Controller dashboard, which includes:
