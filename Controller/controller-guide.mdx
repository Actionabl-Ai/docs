...
<Tip>
  If you need to adjust a rule’s definition, remember that **changes you make here will take effect in <u>ALL</u> automations that use this rule**.
</Tip>
...
1. If no rules in the list are close to the one you need, create a new rule from scratch by clicking the green plus sign at the top right of the popup.