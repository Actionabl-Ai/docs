...
<table class="padding=1em;">
  ...
  <tr><td>**Decision**</td><td>Assess whether a condition has been met, like checking whether an email has been received or if a value matches a criterion.</td><td class="vertical-align: bottom;"><img height="50" src="/images/ICONS/SVGs/DM.svg" /></td></tr>
    ...
    | :------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------ |
    | **Decision**              | Assess whether a condition has been met, like checking whether an email has been received or if a value matches a criterion.                                                                                                          | <img height="75" width="75" src="/images/ICONS/SVGs/DM.svg" />                     |
