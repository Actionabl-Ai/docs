...
4. On the top right, you can search the list or can download it in Excel, CSV, Text, or JSON format.
...
2. Click **Group Users** to open the list of all system users. All users who are currently assigned to this group are checked and listed at the top of this list for convenience.
...
9. Click **Save** to create the new user account. You’ll now see all of this user's setting options.