...
1. On the top right, you can search the list or download it in Excel, CSV, Text, or JSON format.
...
1. Click **Group Users** to open the list of all system users. For convenience, all users currently assigned to this group are checked and listed at the top of the list.
...
1. Make any needed changes to their user groups, department, or password, then click CANCEL to close their details. The changes are now saved and will appear wherever this user’s information is displayed in the system. 