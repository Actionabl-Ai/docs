...
1. Click **Group Assets**. The popup showing all assets appears, with the assets available to the group checked and listed at the top.

![/images/UserManagement/UM6-GroupAssets.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM6-GroupAssets.jpg)

1. At the bottom right of the popup is navigation to multiple pages of results, if needed.

![/images/UserManagement/UM7-assetpagination.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM7-assetpagination.jpg)

1. On the top right, you can search the list or can download it in Excel, CSV, Text, or JSON format.

![/images/UserManagement/UM8-searchanddownload.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM8-searchanddownload.jpg)

1. Click **Close** to return to the list of groups without saving any changes made on this list.
...
1. Click **Group Users** to open the list of all system users. All users who are currently assigned to this group are checked and listed at the top of this list for convenience.
...
1. Check to add or un-check to remove users from this group.
2. If the user you need to add is not yet in the system:
...
3. Click **Save** at the top right of the popup to save the changes to the group.
...
This function makes an exact copy of an existing user and copies over over their permissions, groups, or departments. 
...
1. Click the green **Duplicate** button. The original user record closes on the list and a new copy is open immediately below it. The original is now listed just above the gray box and all of its information has been copied into the new user in the gray box, which now also shows the Password field.

![/images/UserManagement/UM17-duplicate1.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM17-duplicate1.jpg)

1. Change the information in the **User ID**, **User Name**, and **Email** fields. Also update the phone fields, if necessary.

![/images/UserManagement/UM18-DuplicateUser2.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM18-DuplicateUser2.jpg)

1. Enter a temporary password for the new user (they will be required to change it the first time they log in).
2. If the new user is to be active immediately, make sure **Active** is clicked. 
3. Click **Save** to create the new user account. You’ll now see all of this user's setting options.

![/images/UserManagement/UM19-Duplicateuser3.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM19-Duplicateuser3.jpg)

1. The new user is now listed and can log in with the same permissions and groups as the one they were copied from.
2. To change the new user’s permissions, start by clicking **User Groups** and assign them to all of the groups they need. Consult your system administrator, human resources, and/or their manager to determine the appropriate settings for them. Click **Save** after making your selections.
...
1. After adding the groups and departments, click the gray CANCEL button to return to the list of users. The new user appears just under the original one.
...
1. Fill in a **User ID**, which becomes the user’s login. This must: 
   - be unique 
   - contain only alphanumeric characters, plus underscore (_) or dash (-). 
   - cannot contain spaces. 

     The user ID cannot be changed once the record is saved.
2. Enter the user’s name in the **User Name** field. This is the name displayed on their Profile and anywhere they are listed in the data. It is not the user id they use to log in, so it can be changed at any time by the user or an administrator.
3. If the new user is to be active immediately, make sure **Active** is clicked. 
4. Enter the **email address** at which the user should receive system notifications. 
5. Enter their **phone number**. The system will use this number to send SMS notifications. The phone number can be entered using +, ( ), and -, but these are not required. Long-form phone numbers like +1 (800) 555-5555 can be used.
6. Enter a **temporary password** for the new user (they will be required to change it the first time they log in).
7. **Leave the Skills field empty**. This is reserved for future functionality.
8. Click **Save** to create the new user account. You’ll now see all of the options to change this user's settings.
...
1. Start by clicking **User Groups** and assign them to all of the groups they need. Consult your system administrator, human resources, and/or their manager to determine the appropriate settings for them. Click **Save** after making your selections.
...
1. After adding the groups and departments and saving them in the popup, click the gray CANCEL button to return to the list of users. The new user will appear just under the original one.
...
You can edit a user's information if you are the one who created the user OR if you are a member of the Super Auth group.
...
2. You will see all of the fields available to you. Cick the purple **Edit** button to make the fields editable.

![/images/UserManagement/UM28-editinguser.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM28-editinguser.jpg)

1. Make the changes you want, then click the green **Save** button. 

![/images/UserManagement/UM29-edituser2.jpg+_existingInIndexedDbMintlify](/images/UserManagement/UM29-edituser2.jpg)

1. Make any changes to their user groups, department, or password, then click CANCEL to close their details. The changes are now saved and will appear wherever this user’s information is displayed in the system. 